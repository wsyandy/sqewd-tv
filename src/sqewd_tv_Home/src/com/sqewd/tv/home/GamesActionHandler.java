 ...
 * 
 */
public class GamesActionHandler extends AbstractOnClickHandler implements
		PaginatorCallback {
	 ...
	 * @param sources
	 */
	public GamesActionHandler(final ImageButton btn, final TextView view,
		...
		selectLine = HomeContext.get()
				.lookupControl(R.id.dbtn_Home_GamesSelect);
	}
